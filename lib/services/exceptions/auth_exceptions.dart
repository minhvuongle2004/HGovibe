...
class AccountExistsWithDifferentCredentialException implements Exception {
  final String email;
  final List<String> providers; // Danh sách providers hiện tại (ví dụ: ['password'])
  final String attemptedProvider; // Provider đang cố đăng nhập (ví dụ: 'google.com')
  ...
  @override
  String toString() {
    final providerNames = providers.map((p) {
      switch (p) {
        case 'password':
