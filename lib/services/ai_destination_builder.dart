...
class AIDestinationBuilder {
  ...
  static const Map<String, String> _thumbnails = {
    ...
    'Danh lam thắng cảnh': 'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e',
  ...
  static List<String> _generateTags(AIActivitySuggestion suggestion, String category) {
  ...
  static List<Specialty> _generateSpecialtiesFromSuggestion(AIActivitySuggestion suggestion) {
  ...
  static List<Activity> _generateActivitiesFromCategory(String category, AIActivitySuggestion suggestion) {
    switch (category) {
      case 'restaurant':
        return [
          Activity(
  ...
  static String _extractCityFromAddress(String? address) {
    ...
    final cities = ['Hà Nội', 'TP.HCM', 'Đà Nẵng', 'Hội An', 'Huế', 'Nha Trang', 'Cần Thơ', 'Vũng Tàu'];
  ...
  static bool _isKidFriendly(String category) {
    return category == 'restaurant' || category == 'cafe' || category == 'shopping';
  }
