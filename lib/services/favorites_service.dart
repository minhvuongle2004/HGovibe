...
class FavoritesService {
  ...
  CollectionReference<Map<String, dynamic>> _favoritesRefForUser(String userId) =>
  ...
  Future<void> addFavorite({
    ...
    try {
      ...
      if (existing.docs.isNotEmpty) {
        debugPrint('⚠️ Favorite already exists for user $userId, destination $destinationId');
  ...
  Future<void> removeFavorite({
    ...
    try {
      ...
      if (query.docs.isEmpty) {
        debugPrint('⚠️ Favorite not found for user $userId, destination $destinationId');
      ...
      debugPrint('✅ Favorite removed: user=$userId, destination=$destinationId');
    } catch (e, stack) {
  ...
  Future<List<Destination>> getFavoriteDestinations(String userId) async {
    try {
      ...
      debugPrint('✅ Loaded ${destinations.length} favorite destinations for user $userId');
      return destinations;
    } catch (e, stack) {
