...
class DistanceWarningDialog extends StatelessWidget {
  ...
  final Function(Destination)? onSelectSuggestion; // Callback khi user chọn điểm đề xuất
  ...
  Widget build(BuildContext context) {
    final hasSuggestions = validationResult.suggestedDestinations != null &&
                  ...
                  children: [
                    ...
                    if (validationResult.distanceResult != null) ...[
                      _buildInfoRow(
                        ...
                        label: 'Khoảng cách',
                        value: validationResult.distanceResult!.distanceFormatted,
                        color: Colors.blue,
                      ),
                      ...
                      _buildInfoRow(
                        ...
                        value: validationResult.distanceResult!.durationFormatted,
                        color: Colors.orange,
                      ),
                      const SizedBox(height: 20),
                    ],
                    ...
                    if (hasSuggestions) ...[
                      ...
                      ...validationResult.suggestedDestinations!.map((dest) {
                        ...
                        final fromDestination = validationResult.comparedDestination ?? targetDestination;
                        
                        return FutureBuilder<double>(
                          future: _getDistanceBetweenDestinations(fromDestination, dest),
  ...
  Future<double> _getDistanceBetweenDestinations(Destination from, Destination to) async {
    try {
