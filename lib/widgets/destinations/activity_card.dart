...
class _ActivityCardState extends State<ActivityCard> {
  ...
  IconData _getActivityIcon(String name) {
    ...
    if (nameLower.contains('dạo') ||
        nameLower.contains('đi bộ') ||
        nameLower.contains('walk')) {
      return Icons.directions_walk;
    } else if (nameLower.contains('tham quan') ||
        nameLower.contains('explore')) {
      return Icons.explore;
    } else if (nameLower.contains('chụp') ||
        nameLower.contains('ảnh') ||
        nameLower.contains('photo')) {
      return Icons.camera_alt;
    } else if (nameLower.contains('xem') ||
        nameLower.contains('biểu diễn') ||
