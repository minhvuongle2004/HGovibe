...
import '../widgets/destination_card_shimmer.dart';
      ...
      builder: (context, child) {
        ...
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 10), // Khoảng cách hợp lý giữa heading và cards
            SizedBox(
              height: 210, // Giảm từ 320 xuống 210 để loại bỏ khoảng trống
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 8), // Thêm bottom padding 8px để không bị che
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    margin: EdgeInsets.only(
                      right: index == seasonalDestinations.length - 1 ? 0 : 12, // Không margin cho item cuối
                    ),
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: FilterChip(
                  ...
                  onSelected: (selected) {
                    if (selected) {
                      _provider.loadDestinationsByTag(tagData['tag'] as String, limit: 10);
                    } else {
        ...
        ListenableBuilder(
          ...
          builder: (context, child) {
            ...
            return SizedBox(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 8), // Thêm bottom padding
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    width: 200,
                    margin: EdgeInsets.only(
                      right: index == _provider.tagDestinations.length - 1 ? 0 : 12,
                    ),
                    child: _buildCompactDestinationCard(destination),
                  );
                },
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(10, 8, 10, 8), // Giảm top padding từ 10 xuống 8
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisSize: MainAxisSize.min,
                children: [
