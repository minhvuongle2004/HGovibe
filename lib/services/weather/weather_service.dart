    ...
    try {
      ...
      if (_cache.containsKey(cacheKey)) {
        ...
        if (cachedTime != null &&
          ...
          debugPrint(
            '✅ Using cached weather for $city on ${date.toIso8601String().split('T')[0]}',
          );
      ...
      debugPrint(
        '🌤️ Fetching weather for $city on ${date.toIso8601String().split('T')[0]}',
      );
      ...
      if (response.statusCode == 200) {
        ...
        for (var forecast in forecasts) {
          ...
          if (forecastDate.isAtSameMomentAs(targetDate) ||
              (forecastDate.isAfter(targetDate) &&
                  (closestDate == null ||
                      forecastDate.isBefore(closestDate)))) {
        ...
        if (closestForecast != null) {
          ...
          debugPrint(
            '⚠️ No forecast found for $city on ${date.toIso8601String().split('T')[0]}',
          );
          return null;
        }
      } else {
