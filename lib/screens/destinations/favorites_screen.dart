...
import 'package:smart_travel_app/widgets/common/filter_chips_widget.dart';
import 'package:smart_travel_app/widgets/destinations/recommendation_banner_widget.dart';
import 'package:smart_travel_app/widgets/destinations/favorite_card_shimmer.dart';
    ...
    if (userProvider.isLoggedIn && userProvider.user != null) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (favoritesProvider.favorites.isNotEmpty) {
          setState(() {
            _recommendationCity =
                favoritesProvider.favorites.first.location.city;
          });
        } else {
          setState(() {
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Tính năng thêm vào thư mục sẽ được thêm sau'),
                ),
              );
            },
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                // Trái tim màu cam
                Icon(Icons.favorite, size: 120, color: Colors.orange),
